    ...
    def __init__(self, sess, arglist, n_features):
        ...
        with tf.variable_scope('Critic'):
            l1 = tf.layers.dense(
                ...
                kernel_initializer=tf.contrib.layers.variance_scaling_initializer(),  # weights
                bias_initializer=tf.constant_initializer(0.1),  # biases
                name='l1'
            )
...
class SchedulerTrainer(object):
    def __init__(self,sess, n_features, n_actions,arglist):
        self.actor=Actor(sess, arglist, n_features=n_features, n_actions=n_actions)
